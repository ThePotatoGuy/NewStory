...
style vscrollbar:
    ...
    thumb Frame("gui/scrollbar/vertical_poem_thumb.png", top=6, right=6, tile=True)
    unscrollable "hide"
    bar_invert True

style slider:
    ysize 18
    base_bar Frame("gui/slider/horizontal_poem_bar.png", tile=False)
    thumb "gui/slider/horizontal_poem_thumb.png"
